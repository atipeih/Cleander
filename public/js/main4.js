{
    ...
    $('.like').on('click', function () {
        ...
        $.ajax({
            ...
            url: '/like',
            type: 'POST',
            data: { 'postid': postid, 'likeflg': likeflg, },
                })
    ...
    $('.taskRun').on('click', function () {
        ...
        $.ajax({
            ...
            url: '/taskrun',
            type: 'POST',
            data: { 'taskid': taskid, }, //コントローラーに送るデータを指定
                })
            //正常にコントローラーの処理が完了した場合
            .done(function ()
            {
                click_button.children().text('完了');
                click_button.attr('class', 'col-2 btn btn-primary');
                alert('実行しました！');
            })
            ////正常に処理が完了しなかった場合
            .fail(function ()
