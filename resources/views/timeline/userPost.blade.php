@include('layouts.header')
    <div class="main_container flex-row ms-3 justify-content-center">
        <h2 class="page_title mt-2 pb-4 px-4 border-bottom">{{ session('name') }}の投稿</h2>
        ...
        <div class="card w-75 mt-2 mx-auto">
            ...
            <div class="card-body">
                <div class="container d-flex justify-content-between">
                    ...
                    <a class="btn btn-outline-primary pt-3"href="https://twitter.com/intent/tweet?url=http://localhost:8888/sharePost?id={{ encrypt($post->id) }}">共有<i class="bi bi-twitter"></i></a>
