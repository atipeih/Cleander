...
<body>
  ...
  <div class="container-fluid d-flex justify-content-center gap-5">
    ...
    <div class="main_container flex-row ms-3 justify-content-center">
      <h2 class="page_title mt-2">いいねした投稿</h2>
      <div class="card w-75 mt-2 mx-auto">
        <div class="card-header d-flex justify-content-between">
          <p class="mt-3 me-3">ユーザー名</p>
      ...
      <div class="d-flex my-4 pt-3 border-top justify-content-center">
	<a href="#" class="ms-1">1</a>
	<a href="#" class="ms-1">2</a>
	<a href="#" class="ms-1">3</a>
	<a href="#" class="ms-1">次のページ</a>
